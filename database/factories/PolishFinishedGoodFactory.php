...
/**
 * @extends Factory<PolishFinishedGood>
 */
class PolishFinishedGoodFactory extends Factory
{
    /**
    ...
    public function definition(): array
    {
        ...
        return [
            'doc_no' => sprintf('PFG%07d', fake()->unique()->numberBetween(1, 9999999)),
    ...
    {
        return $this->state(fn (array $attributes): array => [
            'status' => PolishFinishedGood::STATUS_DONE,
        ]);
    }
}
