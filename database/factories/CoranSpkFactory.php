...
class CoranSpkFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'weight' => number_format(fake()->randomFloat(2, 1, 20), 2, '.', ''),
            'weight_rosegold' => null,
            'weight_whitegold' => null,
            'weight_yellowgold' => null,
            'kadar' => number_format(fake()->randomElement([37.5, 75, 91.6]), 2, '.', ''),
            'kadar_rosegold' => null,
            'kadar_whitegold' => null,
            'kadar_yellowgold' => null,
            'status' => CoranSpk::STATUS_OK,
            'status_rosegold' => null,
            'status_whitegold' => null,
            'status_yellowgold' => null,
            'is_deleted' => 0,
            'created_date' => now(),
            'created_by' => 'system',
            'modified_date' => now(),
