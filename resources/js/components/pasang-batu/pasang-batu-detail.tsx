...
import {
    PasangBatuStoneTables,
    type PasangBatuStones,
...
type PasangBatuDetailProps = {
    diamondMountingItem: PasangBatuDetailItem;
...
export function PasangBatuDetail({
    diamondMountingItem,
    workflowStatus,
    approvalHistory,
    approvalFooter,
                    ...
                    <div className="spkTopBarMain">
                        <div className="spkTopBarLeft">
                            ...
                            <div
                                ...
                                aria-label="Status Dokumen Pasang Batu"
                            >
                            ...
                            <div className="spkHeaderActions">
                                ...
                                {approval.canOpenEdit ? (
                                    <button
                                        ...
                                        aria-label="Edit"
                                        title="Edit Dokumen Pasang Batu"
                                        disabled={submitting}
                ...
                <div className="spkDetailBody">
                    <section className="spkMainPanel">
                        <div
                            ...
                            role="tablist"
                            aria-label="Konten utama Pasang Batu"
                        >
                            <button
                                type="button"
                                role="tab"
                        ...
                        {mainSection === 'informasi' ? (
                            ...
                            >
                                        ...
                                        <table className="spkItemMetaTable spkItemMetaTable--sm jewelCadDetailNotesTable">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        {displayValue(
                                                            diamondMountingItem.craftsmanName,
                                                        )}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        {formatDateTime(
                                                            diamondMountingItem.sendCraftsmanDate,
                                                        )}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        {formatDateTime(
                                                            diamondMountingItem.receivedCraftsmanDate,
                                                        )}
                                                    </td>
                                                </tr>
                                                <tr>
                                        ...
                                        <table className="spkItemMetaTable spkItemMetaTable--sm jewelCadDetailNotesTable">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        {displayValue(
                                                            diamondMountingItem.weightFrame,
                                                        )}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        {displayValue(
                                                            diamondMountingItem.weightDiamond,
                                                        )}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        {displayValue(
                                                            diamondMountingItem.totalWeight,
                                                        )}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        {displayValue(
                                                            diamondMountingItem.weightFinishGoods,
                                                        )}
                                                    </td>
                                                </tr>
                                                <tr>
                                    ...
                                    {diamondMountingItem.spk === null ? (
                                        ...
                                        <div className="spkDetailGrid">
                                            ...
                                            <DetailField label="Qty">
                                                {diamondMountingItem.spk.satuan}
                                            </DetailField>
                                        </div>
                                    )}
                                </section>
                                ...
                                <section className="spkShowSection">
                                    ...
                                    <PasangBatuStoneTables
                                        stones={diamondMountingItem.stones}
                                    />
                                </section>
