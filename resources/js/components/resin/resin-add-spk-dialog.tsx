...
type ResinAddSpkDialogProps = {
    open: boolean;
    onOpenChange: (open: boolean) => void;
    excludeSpkIds: number[];
    onAdded: (detail: ResinAddedSpk) => void;
};

export function ResinAddSpkDialog({
    open,
    onOpenChange,
    excludeSpkIds,
    onAdded,
}: ResinAddSpkDialogProps) {
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="jewelCadAddSpkDialog">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Cari dan pilih SPK yang akan ditambahkan ke request
                        resin. Berat resin, status, dan catatan diisi di tabel
                        setelah SPK ditambahkan.
                    </DialogDescription>
                </DialogHeader>
