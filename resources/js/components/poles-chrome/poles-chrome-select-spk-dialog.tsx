...
export type PolesChromeSelectedSpk = {
    spk_id: string;
    spk_no: string;
    spk_type: string;
...
type PolesChromeSelectSpkDialogProps = {
    open: boolean;
    onOpenChange: (open: boolean) => void;
    excludeSpkIds?: number[];
    onSelected: (spk: PolesChromeSelectedSpk) => void;
};

export function PolesChromeSelectSpkDialog({
    open,
    onOpenChange,
    excludeSpkIds = [],
    onSelected,
}: PolesChromeSelectSpkDialogProps) {
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="jewelCadAddSpkDialog">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Cari dan pilih satu SPK untuk dokumen Poles Chrome.
                    </DialogDescription>
                </DialogHeader>
