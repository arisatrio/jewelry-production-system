...
type PolesChromeDetailProps = {
    polishFinishedGoodItem: PolesChromeDetailItem;
...
export function PolesChromeDetail({
    ...
    const shrinkTone = shrinkPercentTone(
        polishFinishedGoodItem.shrinkPercent,
        polishFinishedGoodItem.shrinkTolerance ?? null,
    );
                    ...
                    <div className="spkTopBarMain">
                        <div className="spkTopBarLeft">
                            ...
                            <div
                                ...
                                aria-label="Status Dokumen Poles Chrome"
                            >
                            ...
                            <div className="spkHeaderActions">
                                ...
                                {approval.canOpenEdit ? (
                                    <button
                                        ...
                                        aria-label="Edit"
                                        title="Edit Dokumen Poles Chrome"
                                        disabled={submitting}
                ...
                <div className="spkDetailBody">
                    <section className="spkMainPanel">
                        <div
                            ...
                            role="tablist"
                            aria-label="Konten utama Poles Chrome"
                        >
                            <button
                                type="button"
                                role="tab"
                                        ...
                                        <table className="spkItemMetaTable spkItemMetaTable--sm jewelCadDetailNotesTable">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        {displayValue(
                                                            polishFinishedGoodItem.craftsmanName,
                                                        )}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        {formatDateTime(
                                                            polishFinishedGoodItem.sendCraftsmanDate,
                                                        )}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        {formatDateTime(
                                                            polishFinishedGoodItem.receivedCraftsmanDate,
                                                        )}
                                                    </td>
                                                </tr>
                                                <tr>
                                        ...
                                        <table className="spkItemMetaTable spkItemMetaTable--sm jewelCadDetailNotesTable">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        {displayValue(
                                                            polishFinishedGoodItem.startWeight,
                                                        )}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        {displayValue(
                                                            polishFinishedGoodItem.finishWeight,
                                                        )}
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        {polishFinishedGoodItem.shrinkTolerance
                                                            ? formatShrinkPercentDisplay(
                                                                  polishFinishedGoodItem.shrinkTolerance,
                                                              )
                                                            : '—'}
