...
export type PolesRangkaSelectedSpk = {
    spk_id: string;
    spk_no: string;
    spk_type: string;
...
type PolesRangkaSelectSpkDialogProps = {
    open: boolean;
    onOpenChange: (open: boolean) => void;
    excludeSpkIds?: number[];
    onSelected: (spk: PolesRangkaSelectedSpk) => void;
};

export function PolesRangkaSelectSpkDialog({
    open,
    onOpenChange,
    excludeSpkIds = [],
    onSelected,
}: PolesRangkaSelectSpkDialogProps) {
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="jewelCadAddSpkDialog">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Cari dan pilih satu SPK untuk dokumen Poles Rangka.
                    </DialogDescription>
                </DialogHeader>
