...
import { create, index as pasangBatuIndex, show } from '@/routes/pasang-batu';
...
export default function PasangBatuIndex({
    documents,
    spkStatusCounts,
    filters,
        ...
        <>
            ...
            <div className="spkTableShell">
                <div className="spkTableCard">
                    ...
                    <PasangBatuSpkStatusCards counts={spkStatusCounts} />
                    ...
                    <div className="spkTableToolbar">
                        ...
                        <div className="spkTableToolbarRight">
                            <Input
                                accessibleName="Cari dokumen Pasang Batu"
                        ...
                        <table className="spkTable">
                            <thead>
                                <tr>
                                    ...
                                    <th>Tanggal</th>
                                    <th>SPK</th>
                                    <th>Berat Rangka (g)</th>
                                    <th>Berat Batu (g)</th>
                                    <th>Berat Barang Jadi (g)</th>
                                    <th>Susut (g)</th>
                                ...
                                {documents.data.length === 0 ? (
                                    ...
                                    documents.data.map((item) => (
                                        <tr key={item.id}>
                                            ...
                                            <td>{item.weightFrame ?? '—'}</td>
                                            <td>{item.weightDiamond ?? '—'}</td>
                                            <td>{item.weightFinishGoods ?? '—'}</td>
                                            <td>{item.shrink ?? '—'}</td>
                    ...
                    <div className="spkTableFooter">
                        <div className="spkTableTotal">
                            Total {documents.total} dokumen Pasang Batu
                        </div>
...
PasangBatuIndex.layout = {
    activeMenu: 'Pasang Batu',
    pageTitle: 'Pasang Batu',
};
