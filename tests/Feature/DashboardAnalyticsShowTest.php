...
test('home dashboard includes analytics payload', function () {
    $this->get(route('home'))
        ...
        ->assertInertia(fn ($page) => $page
            ...
            ->has('analytics.summary.weekTargetSpk')
            ->has('analytics.summary.weekTargetDoneSpk')
            ->has('analytics.summary.weekTargetLabel')
            ...
            ->has('analytics.weekTarget.targetSpk')
            ->has('analytics.weekTarget.label')
            ->has('analytics.todayLists.todayTarget')
            ->has('analytics.todayLists.weekTarget')
            ...
            ->has('analytics.chartLists.productionTypes')
            ->has('analytics.chartLists.itemDistribution')
            ->has('analytics.chartLists.bottleneck')
            ->has('analytics.chartLists.forecast')
