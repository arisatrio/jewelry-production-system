...
class SkuOutputDashboardController extends Controller
{
    /**
     * Display the SKU output analytics dashboard.
     */
    public function index(Request $request): Response
    {
        $month = $this->resolveMonth($request->string('month')->toString());
        $analytics = (new SpkSkuOutputAnalytics($month))->summarize();
        ...
        return Inertia::render('analytics/sku-output', [
            'analytics' => $analytics,
            'filters' => [
