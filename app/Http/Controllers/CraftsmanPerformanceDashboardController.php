...
class CraftsmanPerformanceDashboardController extends Controller
{
    /**
     * Display the craftsman performance analytics dashboard.
     */
    public function index(Request $request): Response
    {
        $month = $this->resolveMonth($request->string('month')->toString());
        $analytics = (new SpkCraftsmanPerformanceAnalytics($month))->summarize();
        ...
        return Inertia::render('analytics/craftsman-performance', [
            'analytics' => $analytics,
            'filters' => [
